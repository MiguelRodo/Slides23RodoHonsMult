...
Using the paper dataset, we will test whether pulp_2 has an effect on any paper type.
...
We extract the data for the predictor matrix excluding pulp_2, $\symbf{X}^{(2)}$:
