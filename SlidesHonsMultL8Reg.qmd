...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/pcr_vs_ridge.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/pls_alg.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/pcr_vs_pls.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/cv-pcr_and_pls.png")
```
