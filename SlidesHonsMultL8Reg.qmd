...
author: Miguel Rodo & Stefan Britz
date: "2024-04-11"
...
- Each observational unit consists of a single response variable ($y_i$) and multiple predictors ($\symbf{x}_i=x_{i1}, x_{i2}, \ldots, x_{ip}$)
...
\begin{align*}
 &\sum_{i=1}^n\sum_{j=1}^r (\symbf{y}_{ir} - \hat{\symbf{y}}_{ir})'(\symbf{y}_{ir} - \hat{\symbf{y}}_{ir}) \\
