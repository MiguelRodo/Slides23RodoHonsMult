...
$$
\mathrm{Var}[\symbf{X}_i]= \sum_{j=1}^ml_{ij}^2 + \psi_{ii}.
$$
...
- Two solutions are equivalent if a) meet the assumptions of the OFM and b) imply same covariance matrix and specific variances.
...
- Since the solution to the OFM is not unique, we can find initial values for $\hat{\symbf{L}}$ and then rotate them to find a solution that is more interpretable.
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{_raw/img/2024/francesca/fit-pc-short.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{_raw/img/2024/francesca/fit-pc-2.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{_raw/img/2024/francesca/fit-pc-example.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{_raw/img/2024/francesca/fit-pc-example_2.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{_raw/img/2024/francesca/fit-pc-example_3.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{_raw/img/2024/francesca/fit-example2-1.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{_raw/img/2024/francesca/fit-pc-example2-2.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{_raw/img/2024/francesca/fit-ml-1.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{_raw/img/2024/francesca/fit-ml-2.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{_raw/img/2024/francesca/rotation-2.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{_raw/img/2024/francesca/factor-scores.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.875\textwidth]{_raw/img/2024/francesca/factor-scores-example.png}
\end{figure}
