...
path_p <- projr::projr_path_get(
  "cache", "fig", "p-fa-economic-variables-vs-factors.png"
)
cowplot::ggsave2(
  path_p,
  p,
...
path_p <- projr::projr_path_get(
  "cache", "fig", "p-fa-gdp-distribution-given-factors.png"
)
cowplot::ggsave2(
  path_p,
  p,
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-pc-short.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-pc-2.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-pc-example.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-pc-example_2.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-pc-example_3.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-example2-1.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-pc-example2-2.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-ml-1.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/fit-ml-2.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/rotation-2.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/factor-scores.png")
```
...
```{r}
#| results: asis
knitr::include_graphics("_data_raw/img/francesca/factor-scores-example.png")
```
