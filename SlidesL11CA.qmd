...
- We upweight errors arising from less commonly observed rows and cells.
...
&=
\mathrm{tr}[(\symbf{D}_r^{-1/2}\symbf{P}\symbf{D}_c^{-1/2} - \hat{\symbf{P}}^{\ast})(\symbf{D}_r^{-E1/2}\symbf{P}\symbf{D}_c^{-1/2} - \hat{\symbf{P}}^{\ast})'],
\end{align*},
...
![](_raw/img/2024/smoke_example_intro.png)
...
![](_raw/img/2024/smoke_example.png)
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{_raw/img/2024/dual-axis-example.png}
\end{figure}
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca_example_2.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca_example-asymmetric_biplots_1.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca_example-asymmetric_biplots_2.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca_example-quality.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca-multilevel_1.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca-multilevel_2.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca-multilevel_3.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/ca-multilevel_4.png")
```
...
```{r}
#| results: asis
pander::pandoc.image("_raw/img/2024/summary.png")
```
